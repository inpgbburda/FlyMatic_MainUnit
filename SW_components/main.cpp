...
void *calculate_flight_controls(void *data)
{
	/* Do RT specific stuff here */
	printf("Real time thread execution\n");
   ...
   s = pthread_setaffinity_np(thread, sizeof(cpuset), &cpuset);
	...
	attr.sched_deadline = attr.sched_period = 1000000;
...
int main()
{
	...
	*/
	...
	pthread_create(&thread_1, NULL, calculate_flight_controls, NULL);
